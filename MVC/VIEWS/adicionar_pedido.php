<?php
// A conexão já está disponível através da variável $conn fornecida pela classe System
  ...
  <table class="table table-striped table-sm">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?php echo mb_convert_encoding($rows_produtos['produto'], 'UTF-8', 'ISO-8859-1')?></td>
