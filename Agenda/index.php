...
// Caminho relativo para incluir o arquivo de conexão principal do sistema
...
if ($conn) {
    ...
    $result_events = "SELECT id, title, color, start, end FROM atividade";
	...
	<body>
		...
		<div class="container">
			<div class="page-header">
				<h1>Agenda</h1>
				<a class="collapse-item" href="http://localhost:8082/?view=Dashboard1" style="border-radius: 8px; font-size:18px;">Voltar</a>
